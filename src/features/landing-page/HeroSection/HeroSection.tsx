    ...
    return (
        ...
        >
          ...
          `,
            ...
            {/* Content */}
            <div style={{ maxWidth: '920px', textAlign: 'left', position: 'relative', zIndex: 1, padding: '0 48px' }}>
                <div
                    style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', justifyContent: 'flex-start', maxWidth: '480px', margin: '0' }}>
                    <div
                        style={{
                            display: 'flex',
                            alignItems: 'center',
